...
@property (readwrite, nonatomic, assign, getter = isMetric) int metric;
...
@property (readwrite, nonatomic, assign) bool showSpeedScale;
@property (readwrite, nonatomic, retain) NSArray* speedColours;
@property (readwrite, nonatomic, retain) NSString* topSpeedString;
@property (readwrite, nonatomic, retain) NSString* topSpeedUnits;
@property (readwrite, nonatomic, retain) NSString* distanceUnits;
@property (readwrite, nonatomic, retain) NSString* minorDistanceUnits;
